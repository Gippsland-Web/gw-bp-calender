...
(function($)
{
    $.fn.DOPBookingCalendar = function(options)
    {
        var Data = {'Type':'BackEnd',
                    ...
                    'PriceLabel':'', // The text for Price label.
                    'Currency':'', // The currency.
                    'SubmitBtnText':'Save', // The text for Submit button.
                    'ResetBtnText':'Reset', // The text for Reset button.
                    'ExitBtnText':'Cancel', // The text for Exit button.
        ...
        methods = {
                    ...
                    initBackendBookingCalendar:function(){// Init Backend Calendar
                        ...
                        HTML.push('               <option value="0" id="'+UniqueID+'-no-status">Clear</option>');
                        HTML.push('           </select>');
                        HTML.push('           <label class="label" style="display:none;" for="'+UniqueID+'-price">'+priceLabel+' ('+currency+')</label>');
                        HTML.push('           <input type="text" style="display:none;" name="'+UniqueID+'-price" id="'+UniqueID+'-price" class="input-style" value="" />');
